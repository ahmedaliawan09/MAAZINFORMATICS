...
import { MessageCircle, Clock, PhoneCall, CheckCircle, Users, Zap } from "lucide-react"
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-7xl mx-auto px-6 py-16">
                ...
                >
                    <p className={`text-lg leading-relaxed ${darkMode ? "text-stone-300" : "text-stone-700"}`}>
                        We Want To Be The Voice Of Your Company. When You Are Not Available Then We Will Facilitate Your Customers
                        and Provide Them Complete Services on Your Behalf. Our professional answering service ensures your business
                        never misses an important call or opportunity.
                    </p>
                </motion.div>
