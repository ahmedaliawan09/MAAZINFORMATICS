...
import { Database, FileText, Clock, Shield, Zap, CheckCircle } from "lucide-react"
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-7xl mx-auto px-6 py-16">
                ...
                >
                    <p className={`text-lg leading-relaxed ${darkMode ? "text-stone-300" : "text-stone-700"}`}>
                        ...
                        delays during consultations. Focus on patient care while we handle the paperwork.
                    </p>
                </motion.div>
